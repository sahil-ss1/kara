...
class DealsInProgressWidget extends Component
{
    ...
    private function getQuery() {
        ...
        if (($this->startdate)&&($this->enddate))
            $deals->whereBetween('createdate', [$this->startdate, $this->enddate]);
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.deals-in-progress-widget');
    }
}
